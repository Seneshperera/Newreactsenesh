...
function PageTwo() {
  return (
    <div
      className="flex flex-col items-center min-h-screen py-10 px-5 md:px-10"
      style={{
    ...
    >
      ...
      <div className="flex flex-col md:flex-row w-full justify-between mt-10 space-y-10 md:space-y-0">
